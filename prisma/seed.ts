...
async function main() {
  ...
  await prisma.favorite.createMany({
    data: [
      { name: "Moinho Povos Unidos", emoji: "🌾", rating: "4.9", address: "Av. dos Moinhos, 100", date: "15 Ago" },
      { name: "Bloemen Park", emoji: "🌻", rating: "4.8", address: "Estrada da Expoflora", date: "10 Ago", note: "Levar câmera" },
      { name: "Boulevard Holandês", emoji: "🏠", rating: "4.7", address: "Rua Dória Vasconcelos", date: "05 Ago" },
    ]
  })
}
