    ...
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900 overflow-hidden relative w-full border-x border-slate-200 dark:border-slate-800">
      ...
      <div className="flex-1 overflow-y-auto feed-scroll px-5 pt-12 pb-24">
        ...
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex gap-2">
            <button className="h-10 w-10 shrink-0 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-600 dark:text-slate-300 transition-transform hover:scale-105" onClick={() => showToast('❤️ Adicionado aos favoritos!')}>
              <Heart size={18} />
            </button>
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-t border-slate-200 dark:border-slate-800 p-4 max-w-md mx-auto z-20">
        <div className="flex gap-3 h-[52px]">
          <button className="flex-1 bg-gradient-to-r from-orange-500 to-green-500 text-white rounded-xl font-bold text-[15px] shadow-lg shadow-orange-500/30 flex items-center justify-center gap-2 hover:scale-[1.02] transition-transform" onClick={() => showToast('✅ Check-in realizado! +15 pontos')}>
